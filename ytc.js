/**************************************
@Name：微信小程序 隅田川鲜咖啡 签到领积分，咖啡挺好喝的
@Author：Sliverkiss
@Date：2023/9/20 10:00

使用方法：捉h5.youzan.com域名任意包下的Cookie中的KDTWEAPPSESSIONID=XXXXXXXXXX,填写到ytc_data中,多帐号用@分隔
...
// env.js 全局
const $ = new Env("隅田川鲜咖啡小程序签到");
const ckName = "ytc_data";
//-------------------- 一般不动变量区域 -------------------------------------
...
class UserInfo {
    ...
    async signin() {
        try {
            const options = {
                //签到任务调用签到接口
                url: `https://h5.youzan.com/wscump/checkin/checkinV2.json?checkinId=1465878`,
                //请求头, 所有接口通用
